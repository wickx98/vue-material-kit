      ...
      <div class="row">
        <div class="col-md-3 mb-4 ms-auto">
          <div>
            ...
            <p class="text-sm">Empowering smarter urban living through tech-driven solutions.</p>
          </div>
          <div>
        ...
        <div
          ...
          :key="name"
        >
          <h6 class="text-sm text-capitalize">{{ name }}</h6>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="text-dark my-4 text-sm font-weight-normal">
              © {{ new Date().getFullYear() }} Smart City Solutions. Developed for EEI3346 - Web Applications Development, Open University of Sri Lanka.
            </p>
          </div>
        </div>
      </div>
